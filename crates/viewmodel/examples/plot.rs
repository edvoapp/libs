...
fn main() {
    ...
    let root = SVGBackend::new("force.svg", (1200, 675)).into_drawing_area();
    ...
    let m1 = graph.new_member(Some(100.0), Some(100.0), true, Some(50.0), Some(0.0), false);
