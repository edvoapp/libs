...
export const NoteIcon: FunctionComponent<JSX.SVGAttributes> = (props) => (
  <svg width="24" height="24" viewBox="0 0 384 512" fill="#000000" xmlns="http://www.w3.org/2000/svg" {...props}>
