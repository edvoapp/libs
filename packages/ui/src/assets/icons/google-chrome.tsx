...
export const GoogleChrome: FunctionComponent<JSX.SVGAttributes> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="720" height="720" viewBox="0 0 190.5 190.5" {...props}>
